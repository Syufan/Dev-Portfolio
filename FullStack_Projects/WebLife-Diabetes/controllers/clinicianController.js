            ...
            if (tempRecord == null) {
                ...
                if (patientInfo.needToDo.insulin.status == 'no') {
                    ...
                    if (patientInfo.needToDo.insulin.status == 'unrecorded') {
                        ...
                        // console.log(tempRecord,'temRecord');
                        // console.log(patientInfo.needToDo.insulin,'patient');
                        if (!tempRecord.insulin) {
                            tempRecord.insulin = {}
                        }
                ...
                // console.log( patients[i].firstName, ':', tempRecord);
                allRecords.push(
                    Object.assign(
                        { patID: patients[i]._id },
                        patients[i],
...
const setRange = async (req, res, next) => {
    try {
        ...
        if (!req.body.min) {
            ...
            // }
            // else{
            //     var url = '/clinician/dashboard/' + patientId.toString() + task
            //     return res.render(url, {
            //         message: "The max value must greater than min value!"
            //     })
            // }
        }
