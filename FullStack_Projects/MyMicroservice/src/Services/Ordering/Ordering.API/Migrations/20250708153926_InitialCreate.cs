        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardInformation_CardName = table.Column<string>(type: "text", nullable: false),
                    CardInformation_CardNumber = table.Column<string>(type: "text", nullable: false),
                    CardInformation_Expiration = table.Column<string>(type: "text", nullable: false),
